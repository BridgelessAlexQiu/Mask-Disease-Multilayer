...
if __name__ == "__main__":
    ...
    avg_deg_1 = int(sys.argv[1])
    avg_deg_2 = int(sys.argv[2])
    ...
    file_name = "results_part_1/similar/average_degree/p_avgdeg_" + str(avg_deg_1) + "_" + str(avg_deg_2) + ".txt"
    ...
    while trans_prob < 1:
        ...
        # percentage of prosocial people
        pro_soc_p = 0.01
        ...
        # Netowrk path name:
        path_1 = "large_ba/ba_30000_" + str(avg_deg_1) + "_1.npz"
        path_2 = "large_ba/ba_30000_" + str(avg_deg_2) + "_2.npz" 

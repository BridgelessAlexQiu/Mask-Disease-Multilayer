...
if __name__ == "__main__":
    ...
    #g_peer = float(sys.argv[2])
    #g_fear = float(sys.argv[3])
    ...
    #file_name = "results_part_1/similar/prosocial_percentage/g_peer_" + str(g_peer) + "_g_fear_" + str(g_fear) + "_prob_social_dynamic_std_p_prosocial_" + str(pro_soc_p) + ".txt"
    ...
    while trans_prob < 1:
        ...
        alpha = 1  # if the susceptible wears a mask !!!!!!!!!!!!
        beta = 1 # if the infected wears a mask !!!!!!!!!!!!!!!!

...
if __name__ == "__main__":
    ...
    file_name = "results_part_1/similar/prosocial_percentage/habit_formation_habit_p_" + str(habit_p) + ".txt"
    ...
    while trans_prob < 1:
        ...
        for ind in range(itr):
            ...
            # Function call
            final_size, max_frac, days, mask_number = f(A_1, A_2, D_inverse, a_1, t_2, t_3, b_1, b_2, trans_prob, alpha, beta, r, num_iter, habit_p)

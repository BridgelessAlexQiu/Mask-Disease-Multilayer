...
if __name__ == "__main__":
    # Peer
    low_peer = float(sys.argv[1])
    high_peer = float(sys.argv[2])
    ...
    days_vector = []
    mask_number_vector = []
    file_name = "results_part_1/similar/range_of_peer/p_range_of_peer_" + str(low_peer) + "_" + str(high_peer) + ".txt"
    ...
    while trans_prob < 1:
        ...
        for _ in range(itr):
            ...
            # print("Max fraction of infection: {}, the final size: {}".format(max_frac, final_size))
